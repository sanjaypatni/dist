...
class Api {
    constructor() {
        ...
        this.blockchainTransaction = this.protocol + "://" + this.server + "/api/transaction";
...
/* harmony import */ var _safe_pipe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./safe.pipe */ 3289);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_8__.NgModule)({
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_1__.AppComponent, _safe_html_pipe__WEBPACK_IMPORTED_MODULE_5__.SafeHtmlPipe, _safe_pipe__WEBPACK_IMPORTED_MODULE_6__.SafePipe],
        entryComponents: [],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_9__.BrowserModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_10__.IonicModule.forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_0__.AppRoutingModule, _angular_common_http__WEBPACK_IMPORTED_MODULE_11__.HttpClientModule],
        providers: [{ provide: _angular_router__WEBPACK_IMPORTED_MODULE_12__.RouteReuseStrategy, useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_10__.IonicRouteStrategy }, _api__WEBPACK_IMPORTED_MODULE_2__.Api, _messages__WEBPACK_IMPORTED_MODULE_3__.Messages, _models_subscription__WEBPACK_IMPORTED_MODULE_4__.Subscription],
...
let SigninService = class SigninService {
  ...
  createUserDetails(userDetails) {
    ...
    return (0,_Users_sanjaypatni_playclips_ios_latest_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this.deleteUserDetails(_this.userDetails.email);

      yield _this.sleep(1000);
      return _this.httpClient.post(_this.api.userDetailsCreate + "?jwt=" + _this.jwt.token, JSON.stringify(userDetails), _this.httpOptions).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.retry)(2), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.catchError)(_this.handleError)).toPromise();
    })();
  }
  ...
  blockUser(login) {
    ...
    return (0,_Users_sanjaypatni_playclips_ios_latest_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.getUser(login).subscribe(response => {
        _this2.userb = response;
        _this2.userb.auth = "blocked";
        console.log(_this2.userb);
      });

      yield _this2.sleep(1000);
      console.log(_this2.userb);
      console.log(_this2.userb.login);

      _this2.deleteAccount(_this2.userb.login);

      yield _this2.sleep(1000);

      _this2.create(_this2.userb).subscribe(response => {
  ...
  updateSubscription(email, login) {
    ...
    return (0,_Users_sanjaypatni_playclips_ios_latest_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      console.log(email);
      console.log(login);
      console.log(_this3.uuid);

      _this3.getSubscriptionUuid(_this3.uuid).subscribe(response => {
        _this3.subscription = response;
        console.log(response);
        _this3.subscription.login = login;
        _this3.subscription.username = login;
        _this3.subscription.email = email;
        _this3.subscription.uuid = _this3.uuid;
        _this3.subscription.cnclips = 0;
        _this3.subscription.nclips = 50;
        console.log(_this3.subscription);
      });

      yield _this3.sleep(1000);

      _this3.httpClient.delete(_this3.api.subscription + "?uuid=" + _this3.uuid).subscribe(() => {
        _this3.status = 'Delete successful';
        console.log(_this3.status);
      });

      yield _this3.sleep(1000);
      return _this3.httpClient.post(_this3.api.subscription, JSON.stringify(_this3.subscription), _this3.httpOptions).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.retry)(2), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.catchError)(_this3.handleError)).toPromise();
    })();
  }
