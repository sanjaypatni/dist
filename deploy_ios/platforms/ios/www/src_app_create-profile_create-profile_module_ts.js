...
/* harmony import */ var _create_profile_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./create-profile.page.html?ngResource */ 527);
/* harmony import */ var _create_profile_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./create-profile.page.scss?ngResource */ 6593);
...
let CreateProfilePage = class CreateProfilePage {
  constructor(signinService, navCtrl) {
    ...
    this.signinService.getUser(this.signinService.user.login).subscribe(response => {
      ...
      this.signinService.userDetails = new _models_userdetails__WEBPACK_IMPORTED_MODULE_4__.UserDetails();
      if (this.signinService.user.email) this.signinService.getUserDetails(this.signinService.user.email).subscribe(response => {
        if (response != null) this.signinService.userDetails = response;else this.signinService.userDetails = new _models_userdetails__WEBPACK_IMPORTED_MODULE_4__.UserDetails();
      });
    });
  }
  ...
  save() {
    ...
    return (0,_Users_sanjaypatni_playclips_ios_latest_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this.signinService.userDetails.email = _this.signinService.user.email;

      _this.signinService.createUserDetails(_this.signinService.userDetails);

      _this.sleep(1000);

      _this.navCtrl.navigateForward("tab1");
    })();
  }
  ...
  activate() {
    ...
    return (0,_Users_sanjaypatni_playclips_ios_latest_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this2.signinService.updateSubscription(_this2.signinService.user.email, _this2.signinService.user.login);
...
CreateProfilePage = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
  selector: 'app-create-profile',
  template: _create_profile_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__,
  styles: [_create_profile_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__]
})], CreateProfilePage);
