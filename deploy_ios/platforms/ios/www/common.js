...
class Content {
    constructor() {
        ...
        this.likeCnt = 0;
        this.unlikeCnt = 0;
        this.thumbnail = "assets/img/logo.png";
        this.like = false;
        this.object = 0;
        this.unlike = false;
        this.archive = 0;
...
let SubscriptionService = class SubscriptionService {
    ...
    createSubscription(sub) {
        return this.http
            .post(this.api.subscription, JSON.stringify(sub), this.httpOptions)
    ...
    get(email) {
        console.log(email);
        return this.http.get(this.api.subscription + "?email=" + email)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.retry)(2), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.catchError)(this.handleError));
    }
    // Handle API errors
    handleError(error) {
...
SubscriptionService = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_Users_sanjaypatni_playclips_ios_latest_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_Users_sanjaypatni_playclips_ios_latest_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_Users_sanjaypatni_playclips_ios_latest_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
