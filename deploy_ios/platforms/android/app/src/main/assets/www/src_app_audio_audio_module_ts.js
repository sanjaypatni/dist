"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["src_app_audio_audio_module_ts"],{

/***/ 6966:
/*!***********************************************!*\
  !*** ./src/app/audio/audio-routing.module.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AudioPageRoutingModule": () => (/* binding */ AudioPageRoutingModule)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 2321);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 2560);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 124);
/* harmony import */ var _audio_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./audio.page */ 9456);
...
const routes = [
    {
        path: '',
        component: _audio_page__WEBPACK_IMPORTED_MODULE_0__.AudioPage
    }
];
let AudioPageRoutingModule = class AudioPageRoutingModule {
};
AudioPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AudioPageModule": () => (/* binding */ AudioPageModule)
/* harmony export */ });
...
/* harmony import */ var _audio_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./audio-routing.module */ 6966);
/* harmony import */ var _audio_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./audio.page */ 9456);
...
AudioPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule,
            _audio_routing_module__WEBPACK_IMPORTED_MODULE_0__.AudioPageRoutingModule
        ],
        declarations: [_audio_page__WEBPACK_IMPORTED_MODULE_1__.AudioPage]
    })
], AudioPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AudioPage": () => (/* binding */ AudioPage)
/* harmony export */ });
...
/* harmony import */ var _audio_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./audio.page.html?ngResource */ 1839);
/* harmony import */ var _audio_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./audio.page.scss?ngResource */ 2916);
...
let AudioPage = class AudioPage {
  ...
  submitForm() {
    ...
    return (0,_Users_playclips_latest_client_inapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this.file.size > 90096000) {
        _this.showToast("File size restricted to less then 90MB");
      ...
      const rheaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_9__.HttpHeaders({
        'Transfer-Encoding': 'chunked'
      });

      _this.presentLoading();

      _this.http.post(_this.api.upload, formData, {
        headers: rheaders
      }).subscribe(response => {
  ...
  submitFormThumbnail() {
    ...
    return (0,_Users_playclips_latest_client_inapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this2.thumbnail.size > 30096000) {
      ...
      const formData = new FormData();
      formData.append("file", _this2.thumbnail, _this2.thumbnail.name);
      const rheaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_9__.HttpHeaders({
        'Transfer-Encoding': 'chunked'
      });
      ...
      _this2.http.post(_this2.api.upload, formData, {
        ...
        _this2.thumbnailLink = response.link;
        _this2.content.thumbnail = _this2.thumbnailLink;
      });
    })();
  }
...
AudioPage = (0,tslib__WEBPACK_IMPORTED_MODULE_12__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_13__.Component)({
  selector: 'app-audio',
  template: _audio_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__,
  styles: [_audio_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__]
})], AudioPage);
...
/***/ 2916:
/*!**************************************************!*\
  !*** ./src/app/audio/audio.page.scss?ngResource ***!
  \**************************************************/
/***/ ((module) => {

module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhdWRpby5wYWdlLnNjc3MifQ== */";

/***/ }),

/***/ 1839:
/*!**************************************************!*\
  !*** ./src/app/audio/audio.page.html?ngResource ***!
  \**************************************************/
/***/ ((module) => {

module.exports = "  <ion-header>\n  <ion-toolbar>\n    <ion-title>Audio</ion-title>\n    <ion-buttons>\n      <ion-back-button defaultHref=\"create-contents\"></ion-back-button>\n    </ion-buttons>\n  </ion-toolbar>\n </ion-header>\n <ion-content>\n <ion-list lines=\"none\">\n <ion-item>\n    <ion-label position=\"stacked\"> Title:</ion-label>\n    <ion-input type=\"title\" placeholder=\"Title\" [(ngModel)]=\"signinService.title\"></ion-input>\n  </ion-item>\n  <ion-item>\n    <ion-label position=\"stacked\"> Audio:</ion-label>\n    <input type=\"file\" (change)=\"onFileChange($event)\" enctype=\"multipart/form-data\"   accept=\"audio/*\" />\n    <ion-button color=\"danger\" expand=\"full\"  shape=\"round\" (click)=\"submitForm()\">Upload</ion-button>\n  </ion-item>\n  <ion-item>\n    <ion-label position=\"stacked\"> Thumbnail:</ion-label>\n    <input type=\"file\" (change)=\"onFileChangeThumbnail($event)\" enctype=\"multipart/form-data\"   accept=\"image/*\" />\n    <ion-button color=\"danger\" expand=\"full\"  shape=\"round\" (click)=\"submitFormThumbnail()\">Upload</ion-button>\n  </ion-item>\n  <ion-item>\n    <video  controls poster=\"{{ content.thumbnail }}\" width=\"225\" height=\"175\">\n     <source src=\"{{ content.link }}\" type=\"video/mp4\" >\n     Your browser does not support the <code>audio</code> element.\n    </video>\n  </ion-item>\n  <ion-item>\n      <ion-button expand=\"block\" color=\"danger\" shape=\"round\"  (click)=\"save()\" >Save</ion-button>\n      <ion-button expand=\"block\" color=\"danger\"  shape=\"round\" (click)=\"cancel()\" >Cancel</ion-button>\n  </ion-item>\n </ion-list>\n</ion-content>\n";

/***/ })

}]);
//# sourceMappingURL=src_app_audio_audio_module_ts.js.map